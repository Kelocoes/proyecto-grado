...
class IAModel:
    def __init__(self):
        ...
        self.pipeline_inputer = joblib.load(os.path.join(BASE_DIR, './pipeline_inputer.joblib'))
        self.pipeline_norm = joblib.load(os.path.join(BASE_DIR, './pipeline_norm.joblib'))
    ...
    def predict(self, data):
        ...
        columns = ["sexo", "diabetes", "tabaco", "antecedentes", 
